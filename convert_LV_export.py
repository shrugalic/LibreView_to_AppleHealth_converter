...
ICLOUD_BASE_DIR = '/private/var/mobile/Library/Mobile Documents'
# To run the script on your Mac you'd use this instead:
# ICLOUD_BASE_DIR = str(Path.home()) + '/Library/Mobile Documents'

# I'm using the 'Pythonista 3' folder in the iCloud drive of my iPhone as base directory:
BASE_DIR = ICLOUD_BASE_DIR + '/iCloud~com~omz-software~Pythonista3/Documents'
